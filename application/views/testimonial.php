    ...
    <div class="container">
        ...
        <div class="row featurette">
            <div class="row">
                <?php
                if (isset($allTesti)):
                    foreach ($allTesti as $tesRows):
                        ?>                
                        <div class="col-xs-12 col-md-12">
                            <div class="col-md-2"></div>
                            <div class="col-xs-12 col-md-8 testimonial">                                
                                <p class="lead"><i class="fa fa-quote-left fa-2x"></i> <?php echo $tesRows->testimonial; ?> <i class="fa fa-quote-right fa-2x"></i></p>
                                <p class="text-info text-right">Testimonial Oleh : <?php echo $tesRows->name;?> ~ Domisili : <?php echo $tesRows->location;?></p>
                                <hr>
                ...
                ?>
                <div class="pager pull-right"> <?php echo $halaman; ?> </div>
            </div>   
            <hr class="featurette-divider">
            <div class="col-xs-12 col-md-12">

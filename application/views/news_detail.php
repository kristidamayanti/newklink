                    ...
                    <div class="list-group">
                        ...
                        if (sizeof($newsCat) > 0):
                            foreach ($newsCat as $row):
                                echo anchor('news/cat/' . $row->cat_id, $row->title, array("class" => "list-group-item"));
                            endforeach;
                        endif;
                        ?>   
                    </div>                     
                    ...
                    if (sizeof($newsDet) > 0):
                        ...
                        <div class="row">  
                            ...
                            <div class="col-xs-9 col-md-9">
                                ...
                                <p>Posted : <?php echo date('d-m-Y h:i:s', strtotime($row->tanggal)); ?> | <i class="fa fa-user"></i> By <?php echo strtolower($row->createnm); ?></p>
                                <hr>
                                <?php echo $row->news; ?>
                            </div>                                

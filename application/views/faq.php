              ...
              <div class="col-md-6 checkout"> 
                ...
                <span>Answer : </span>
                    <?php
                            ...
                            endforeach;
                                    ?>                	
                    <span class="checkout_arrow"></span>
				</div> 
                <div class="checkout_info">
                	<div class="checkout_photo"><img class="img-responsive" src="<?php echo base_url(); ?>images/answer.jpg" alt="" /></div>
					<div class="checkout_autor" style="padding-top:5px;">Question # <?php echo $que->id; ?> </div>
					<div class="checkout_website"><?php echo strip_tags($que->question); ?></div>
				</div>
				</div>
			</section>
		<!-- checkout end -->

        ...
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <div class="page-header">
                    <h1><i class="fa fa-bookmark-o fa-2x text-primary"></i> ARCHIVE <?php echo $year; ?></h1>
                </div>
            </div>
            <div class="col-xs-12 col-md-12">
                <br>            
                        ...
                        <ol>
                            ...
                            if (isset($allBlog)):
                                foreach ($allBlog as $row):
                                    echo "<li>" . anchor($type_url . '/' . $row->id . '/' . url_title($row->bl_title), $row->bl_name . " ~ " . $row->bl_title . "~ Posted date : " . $row->createdt) . "</li>";
                                endforeach;
                            endif;
                            ?>
                        </ol>

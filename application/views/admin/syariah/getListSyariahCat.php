<?php
    if(isset($listSyariahCat))
    {
       ...
       echo "<tbody>";
       $i = 1;
       foreach($listSyariahCat as $list) {
                echo "<tr id=\"$i\">";
                ...
                echo "<a class=\"btn btn-mini btn-info\" onclick=\"Syariah.getUpdateSyariahCat($i)\"><i class=\"icon-edit icon-white\"></i></a>";
                echo "&nbsp;<a class=\"btn btn-mini btn-danger\" onclick=\"Syariah.deleteSyariahCat($i)\"><i class=\"icon-trash icon-white\"></i></a>";
                echo "</div></td>";
                echo "</tr>";
              $i++; 
        }

<?php
    if(isset($listGalCat))
    {
       ...
       echo "<thead><tr ><th colspan=5 bgcolor=#lightgrey>List Gallery Category</th></tr>";
       ...
       foreach($listGalCat as $list) {
                ...
                echo "<a class=\"btn btn-mini btn-info\" onclick=\"Gallery.getUpdateGalleryCat($i)\"><i class=\"icon-edit icon-white\"></i></a>";
                echo "&nbsp;<a class=\"btn btn-mini btn-danger\" onclick=\"Gallery.deleteGalleryCat($i)\"><i class=\"icon-trash icon-white\"></i></a>";
                echo "</div></td>";
                echo "</tr>";
              $i++; 
        }

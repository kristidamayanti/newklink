<?php
    if(isset($listNewsCat))
    {
       ...
       foreach($listNewsCat as $list) {
                ...
                echo "<a class=\"btn btn-mini btn-info\" onclick=\"News.getUpdateNewsCat($i)\"><i class=\"icon-edit icon-white\"></i></a>";
                echo "&nbsp;<a class=\"btn btn-mini btn-danger\" onclick=\"News.deleteNewsCat($i)\"><i class=\"icon-trash icon-white\"></i></a>";
                echo "</div></td>";
                echo "</tr>";
              $i++; 
        }

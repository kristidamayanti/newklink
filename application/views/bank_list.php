    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                <h2 class="sub-header">Daftar Artikel</h2>
                <div class="table-responsive">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            if (count($article) > 0):
                                $i = 1;
                                foreach ($article as $rowAdd):
                                    $no = $i++;
                                    ?>
                                    <tr>
                                        <td><?php echo $no ?></td>
                                        <td><?php echo $rowAdd->ld_title ?></td>
                                        <td><?php echo $rowAdd->ld_type ?></td>
                                        <td><?php echo word_limiter($rowAdd->ld_content, 80) ?></td>                                        
                                        <td><?php echo date('D-m-Y H:i:s', strtotime($rowAdd->createdt)) ?></td>                                        
                                        <td><?php echo $rowAdd->createnm ?></td>                                        
                    ...
                    <?php echo "<div class=\"pager pull-right\">" . $halaman . "</div>"; ?>
                </div>
            </div>
        </div>
    </div>

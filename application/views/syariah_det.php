...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-md-12">
                <img class="img-responsive" src="<?php echo base_url() . 'images/syariah.jpg' ?>" alt="Stockist Logo">
            </div>
        </div>
        <div class="row">      
            <div class="col-xs-12 col-sm-4  col-md-4">
				...
				<div class="list-group">
                    ...
                    <?php
                    if (isset($listJawab)):
                        foreach ($listJawab as $rowList):
                            echo anchor('syariah/ask/' . $rowList->id . '/' . url_title($rowList->bl_title), $rowList->bl_title, "class='list-group-item'");
                        endforeach;
                    endif;
                    ?>                                                     
                </div> 
